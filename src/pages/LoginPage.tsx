...
export default function LoginPage() {
  ...
  const text = {
    en: {
      ...
      hint: 'No account yet? Sign up is automatic. Existing users restore their data.',
    ...
    es: {
      ...
      hint: '¿Sin cuenta? El registro es automático. Los usuarios existentes restauran sus datos.',
    ...
    ko: {
      ...
      google: 'Google로 계속하기',
      hint: '계정이 없으면 자동 가입됩니다. 기존 계정은 데이터 그대로 복원됩니다.',
