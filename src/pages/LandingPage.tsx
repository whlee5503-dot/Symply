...
const CONTENT = {
  en: {
    ...
    freeFeatures: ['✓ Unlimited symptom logging', '✓ Calendar heatmap', '✓ Trend charts', '✓ Pattern Insights (preview)'],
    ...
    startPro: '✨ Start Pro',
    builtBy: 'Built by a <b>public health professional (MPH)</b> who believes chronic illness patients deserve to be heard. MPH-informed design. No ads. No data sales.',
  ...
  es: {
    ...
    freeFeatures: ['✓ Registro ilimitado de síntomas', '✓ Mapa de calor del calendario', '✓ Gráficos de tendencias', '✓ Insights de patrones (vista previa)'],
    ...
    builtBy: 'Creado por un <b>profesional de salud pública (MPH)</b> que cree que los pacientes crónicos merecen ser escuchados. Diseño basado en formación MPH. Sin anuncios. Sin venta de datos.',
  ...
  ko: {
    ...
    solutions: [
      ...
      { emoji: '📄', title: '몇 초 만에 진료 보고서 생성', body: '수개월의 증상을 요약한 1~2페이지 임상 PDF를 생성합니다. MPH 전문가가 설계했습니다.', badge: 'Pro', color: '#7c3aed' },
    ],
    pricingLabel: '가격',
    pricingTitle: '한 달에 커피 한 잔보다 저렴합니다.',
    pricingSub: '광고 없음. 데이터 판매 없음.',
    freeFeatures: ['✓ 무제한 증상 기록', '✓ 달력 히트맵', '✓ 트렌드 차트', '✓ 패턴 인사이트 (미리보기)'],
    proFeatures: ['✓ 무료 기능 전체', '✓ AI 패턴 분석', '✓ 진료 보고서 PDF', '✓ 우선 지원'],
    proSave: '또는 $29.99/년 — 37% 절약',
    startFree: 'Google로 시작하기',
    startPro: '✨ Pro 시작하기',
    builtBy: '<b>공중보건 전문가(MPH)</b>가 만성질환 환자들이 마땅히 들을 자격이 있다는 신념으로 만들었습니다. MPH 전문가 설계. 광고 없음. 데이터 판매 없음.',
