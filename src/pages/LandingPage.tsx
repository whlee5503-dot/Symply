...
const CONTENT = {
  en: {
    badge: '🩺 For PCOS · Endometriosis · Fibromyalgia',
    ...
    freeFeatures: ['✓ Unlimited symptom logging', '✓ Calendar heatmap', '✓ Trend charts', '✓ Weather auto-detection', '✓ Pattern Insights (preview)'],
    proFeatures: ['✓ Everything in Free', '✓ AI Pattern Analysis', "✓ Doctor's Report PDF", '✓ Flare Prediction (coming soon)', '✓ Priority support'],
    proSave: 'or $29.99/year — save 37%',
    startFree: 'Get Started Free',
    startPro: '✨ Start Pro',
    builtBy: 'Built by a <b>public health professional (MPH)</b> who believes chronic illness patients deserve to be heard. Evidence-based content from WHO & Cochrane. No ads. No data sales.',
  ...
  ko: {
    ...
    startFree: '무료로 시작하기',
    startPro: '✨ Pro 시작하기',
    builtBy: '<b>공중보건 전문가(MPH)</b>가 만성질환 환자들이 마땅히 들을 자격이 있다는 신념으로 만들었습니다. WHO & Cochrane 근거 기반 콘텐츠. 광고 없음. 데이터 판매 없음.',
