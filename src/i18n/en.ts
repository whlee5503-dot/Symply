export const en = {
  ...
  home: {
    ...
    trigger_high_fodmap: 'High-FODMAP meal',
    trigger_high_glycemic: 'High-glycemic meal',
    ...
    triggers_primary_hint: 'Factors marked with ★ have the strongest evidence for your primary condition. All factors still count toward your log either way.',
  ...
  settings: {
    ...
    primary_condition_title: 'Primary Condition',
    primary_condition_sub: 'Which one affects you most day to day. Used to prioritize which factors are highlighted during check-in.',
    primary_condition_none: 'Pick one above to personalize your daily check-in.',
    ...
    guest_banner_title: 'You are browsing as a guest',
    guest_banner_body: 'Your entries are saved for now, but they may be lost if you clear your browser data. Connect an account to keep your history and access it from other devices.',
    guest_link_google: 'Connect with Google',
    guest_link_email_toggle: 'Connect with email',
    guest_link_email_label: 'Email',
    guest_link_password_label: 'Password (6+ characters)',
    guest_link_submit: 'Connect account',
    guest_link_cancel: 'Cancel',
    guest_link_error: 'Something went wrong. Please try again.',
    ...
    sign_out_guest_title: 'This is a guest account',
    sign_out_confirm_guest: 'A guest account cannot be signed back into. If you sign out now, everything you have logged will be lost permanently. We recommend connecting an account above first.',
    sign_out_yes_guest: 'Sign out anyway (data will be lost)',
  ...
  onboarding: {
    ...
    preview_chart_caption: 'Daily pain & fatigue scores (0-10, last 10 days)',
    preview_legend_pain: 'Pain',
    preview_legend_fatigue: 'Fatigue',
