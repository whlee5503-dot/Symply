...
export const ko: Translations = {
  ...
  guide: {
    title: 'Symply 사용 가이드',
    intro: 'Symply는 증상을 기록하고, 패턴을 발견하고, 의사와 더 효과적으로 소통할 수 있도록 돕습니다. 각 기능을 간단히 소개합니다.',
    pages_title: '화면별 안내',
    pages: [
      {
        icon: '🏠',
    ...
    terms: [
      {
        icon: '📏',
        term: '통증 앵커 척도',
        desc: '숫자만이 아닌 실제 비유 설명이 각 레벨에 포함되어 있습니다. 예를 들어 6은 "하던 일을 멈춰야 할 정도"를 의미합니다. 힘든 날에도 일관된 기록이 가능합니다.',
      },
      {
        icon: '🔍',
        term: '오늘의 영향 요인',
...

      {
        ...
        desc: '전신에 광범위한 근골격계 통증, 피로, 수면 장애, 인지 어려움을 일으키는 만성 질환입니다. 스트레스, 수면, 활동량에 의해 증상이 옵락가락하는 것이 특징입니다.',
      },
      {
        icon: '🫀',
        term: '루푸스 (SLE)',
        desc: '면역계가 정상 조직을 공격하는 전신성 자가면역질환입니다. 피부, 관절, 신장 등에 영향을 미치며, 예측하기 어려운 플레어와 호전이 반복되는 것이 특징입니다.',
      },
      {
        icon: '🦴',
        term: '류마티스 관절염 (RA)',
        desc: '자가면역 반응으로 관절 염증, 통증, 부기가 지속적으로 나타나는 질환입니다. 관절 주변 조직을 손상시키며 시간이 지나면 다른 신체 기관에도 영향을 줄 수 있습니다.',
      },
      {
        icon: '🪲',
        term: '크론병 (Crohn's Disease)',
        desc: '소화관 어느 부위든 염증을 일으킬 수 있는 염증성 장질환(IBD)의 일종입니다. 복통, 설사, 피로, 체중 감소가 주요 증상입니다.',
      },
      {
        icon: '⚡',
        term: '과민성 대장 증후군 (IBS)',
        desc: '복통, 팔묽임, 배변 변화를 일으키는 기능성 장 장애입니다. 호르몳 주기, 스트레스, 식습관이 증상에 영향을 주는 것으로 알려져 있습니다.',
      },
      {
        icon: '😴',
        term: '만성 피로 증후군 (ME/CFS)',
        desc: '휴식으로 회복되지 않는 극심한 피로, 인지 장애(롼안개), 활동 후 증상 악화(PEM)를 특징으로 하는 복잡한 만성 질환입니다.',
      },
      {
        icon: '⚡',
        term: '플레어 (Flare)',
