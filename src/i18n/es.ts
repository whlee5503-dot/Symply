...
export const es: Translations = {
  ...
  settings: {
    ...
    sign_out_guest_title: 'Esta es una cuenta de invitado',
    sign_out_confirm_guest: 'No es posible volver a iniciar sesión en una cuenta de invitado. Si cierras sesión ahora, todo lo que has registrado se perderá de forma permanente. Te recomendamos conectar una cuenta arriba primero.',
    sign_out_yes_guest: 'Cerrar sesión de todos modos (se perderán los datos)',
  ...
  onboarding: {
    ...
    preview_chart_caption: 'Puntuación diaria de dolor y fatiga (0-10, últimos 10 días)',
    preview_legend_pain: 'Dolor',
    preview_legend_fatigue: 'Fatiga',
